...
import VehicleGroupingManagement from "./VehicleGroupingManagement";
import CreditLimitsManagement from "./CreditLimitsManagement";
    ...
    <div className="mx-auto max-w-7xl p-6">
      ...
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600 dark:text-gray-400">
          Manage credit customers and monitor credit activities with
          comprehensive tools
        </p>
      </div>
      ...
      <Tabs defaultValue="dashboard">
        ...
        {/* Dashboard Tab - Your existing content */}
              ...
              <div className="flex items-center overflow-hidden">
                ...
                <div className="ml-4 flex-1 min-w-0">
                  ...
                  <p className="text-2xl font-semibold text-gray-900 dark:text-white break-words">
                    ₹
                    {Number(creditStats.totalCreditLimit).toLocaleString(
                      "en-IN"
                    )}
                  </p>
                </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
              <div className="flex items-center overflow-hidden">
                ...
                <div className="ml-4 flex-1 min-w-0">
                  ...
                  <p className="text-2xl font-semibold text-gray-900 dark:text-white break-words">
                    ₹
                    {Number(creditStats.totalOutstanding).toLocaleString(
                      "en-IN"
                    )}
                  </p>
                </div>
                  ...
                  {recentPartners.length > 0 ? (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">
                          <button
                            onClick={() =>
                              navigate(
                                `/fuel-admin/credit-partners/${partner.id}`
                              )
                            }
                    ...
                    <tr>
                      ...
                      >
                        ...
                        <button
                          onClick={() =>
                            navigate("/fuel-admin/credit-onboarding")
                          }
        ...
        {/* Credit Limits Tab */}
        <TabsContent value="credit-limits" className="space-y-6">
